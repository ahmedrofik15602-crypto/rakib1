...
global.utils = require("./Joyd.js");
global.loading = require("./Joyc.js");
...
try {
  ...
  logger.loader(`deployed ${chalk.blueBright('Joy')} file`);
} catch (e) {
  return logger.loader(`can't deploy ${chalk.blueBright('Joy')} file`, "error")
}
